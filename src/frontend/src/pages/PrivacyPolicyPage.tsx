      ...
      <div className="px-4 pt-6 max-w-2xl mx-auto">
        ...
        >
          <p className="text-white/80 text-sm leading-relaxed">
            PITTHU Technologies Pvt. Ltd. (<strong>"PITTHU"</strong>) is
            ...
            use the PITTHU app or website for ride booking and drone delivery
            services across Uttarakhand, India.
          </p>
        </motion.div>
        ...
        <div className="mt-6 text-center text-white/40 text-xs">
          By using PITTHU, you agree to this Privacy Policy. We may update this
          policy periodically — continued use constitutes acceptance of any
          changes.
        </div>
      </div>
    </div>
