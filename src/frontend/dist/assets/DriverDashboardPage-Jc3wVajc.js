import { c as createLucideIcon, p as useAuth, o as useNavigate, r as reactExports, g as getAllBookings, j as jsxRuntimeExports, aa as Link, s as RefreshCw, ac as Label, k as ue, A as AnimatePresence, m as motion, ah as WifiOff, ai as Wallet, d as Car, h as Star, B as Badge, n as Button, M as MapPin, z as TriangleAlert, t as CircleCheck, v as Clock, w as updateBookingStatus } from "./index-ek8sCczs.js";
import { S as Switch } from "./switch-BHswnYic.js";
import { A as ArrowLeft } from "./arrow-left-BurPhnK6.js";
import { C as CircleCheckBig } from "./circle-check-big-CMaHlQwh.js";
/**
...
function DriverDashboardPage() {
  ...
  const [completedBookings, setCompletedBookings] = reactExports.useState(
    []
  );
  ...
  const loadBookings = reactExports.useCallback(() => {
    ...
    const pending = isOnline ? all.filter(
  ...
  reactExports.useEffect(() => {
    ...
    loadBookings();
    const interval = setInterval(loadBookings, 8e3);
  ...
  if (!authChecked) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 to-blue-950 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/50 text-sm", children: "Checking access..." }) });
  }
  const tabs = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 to-blue-950 text-white pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 backdrop-blur-md border-b border-white/20 px-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-orange-500 flex items-center justify-center font-bold text-sm shrink-0", children: initials })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3 bg-white/5 rounded-xl px-4 py-2.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
          {
            ...
            onCheckedChange: (val) => {
              setIsOnline(val);
              ue.info(val ? "You're now online" : "You're now offline");
            },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: !isOnline && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-2.5 text-gray-300 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-4 h-4 text-gray-400 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "You're offline — new rides won't appear" })
        ] })
      }
    ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4 flex gap-2", "data-ocid": "driver_dashboard.tab", children: tabs.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setTab(t.key),
        "data-ocid": "driver_dashboard.tab",
        className: `flex-1 py-2.5 rounded-xl text-xs font-semibold transition-all ${tab === t.key ? "bg-gradient-to-r from-blue-600 to-orange-500 text-white shadow-lg" : "bg-white/10 text-white/60 hover:bg-white/15"}`,
        children: [
          t.label,
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `ml-1 inline-flex items-center justify-center w-5 h-5 rounded-full text-xs ${tab === t.key ? "bg-white/20" : "bg-white/10"}`,
              children: t.count
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4 space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatePresence, { mode: "wait", children: [
          ...
          children: pendingBookings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50", children: isOnline ? "No available rides right now" : "You're offline" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-sm mt-1", children: isOnline ? "New bookings will appear here" : "Go online to see new bookings" })
              ]
            }
      ...
      tab === "completed" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, x: 20 },
          animate: { opacity: 1, x: 0 },
          exit: { opacity: 0, x: 20 },
          className: "space-y-3",
          children: completedBookings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 text-center",
              "data-ocid": "driver_dashboard.empty_state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-12 h-12 mx-auto mb-3 text-white/30" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50", children: "No completed rides yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-sm mt-1", children: "Finished rides will appear here" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-green-900/40 to-green-800/20 border border-green-500/30 rounded-2xl p-4 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-300 text-xs font-semibold uppercase tracking-wide", children: "Total Earned" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 font-black text-2xl", children: [
                  "₹",
                  todayEarnings
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "w-8 h-8 text-green-400/50 mt-1 ml-auto" })
              ] })
            ] }),
            completedBookings.map((booking, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                initial: { opacity: 0, y: 16 },
                animate: { opacity: 1, y: 0 },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-green-400" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: booking.userName }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-xs capitalize", children: booking.vehicle })
                      ] })
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-400 font-bold text-base", children: [
                        "₹",
                        Math.round(booking.fare * 0.85)
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/30 text-xs", children: "earned" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-white/50 mt-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-white/30 mt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3 shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(booking.time).toLocaleString("en-IN", {
                      dateStyle: "short",
                      timeStyle: "short"
                    }) })
                  ] })
