import { c as createLucideIcon, n as useNavigate, o as useAuth, r as reactExports, p as getAllBookings, j as jsxRuntimeExports, l as Button, q as ChevronLeft, s as RefreshCw, e as Card, f as CardContent, t as CircleCheck, U as User, d as Car, v as Clock, M as MapPin, N as Navigation, w as updateBookingStatus } from "./index-CG-f2g7d.js";
...
function AdminPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-10 bg-slate-900/90 backdrop-blur-md border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 h-16 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-6 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: ["pending", "accepted", "ongoing", "completed"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
