import { c as createLucideIcon, r as reactExports, Y as useDirection, J as useControllableState, j as jsxRuntimeExports, K as createContextScope, a4 as useId, V as Primitive, a5 as createRovingFocusGroupScope, a6 as Root, a7 as Item, Q as composeEventHandlers, a8 as Presence, a as cn, o as useNavigate, p as useAuth, m as motion, a9 as Mountain, aa as Link, ab as findUserByPhone, k as ue, ac as Label, U as User, a2 as Input, A as AnimatePresence, n as Button, ad as LogIn } from "./index-BdPBuX-3.js";
/**
...
function LoginForm({
  ...
  const loginDisabled = !name.trim() || phone.length < 10 || adminPasswordRequired && password.length === 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: adminPasswordRequired && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, height: 0 },
            animate: { opacity: 1, height: "auto" },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-white/80 text-sm", children: "Admin Password" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center bg-white/10 border border-white/20 rounded-xl px-3 text-white/60 shrink-0 h-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
...
function LoginPage() {
  ...
  const handleLogin = () => {
    ...
    if (phone === ADMIN_PHONE && password !== ADMIN_PASSWORD) {
      ue.error("Incorrect admin password");
      return;
    }
