import { c as createLucideIcon, u as useSearch, o as useNavigate, r as reactExports, j as jsxRuntimeExports, aa as Link, n as Button, B as Badge, m as motion, M as MapPin, v as Clock, d as Car, N as Navigation, t as CircleCheck, Z as Zap, g as getAllBookings } from "./index-BdPBuX-3.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-white/10 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 text-xs", children: date }),
              booking.paymentStatus === "paid" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 bg-green-500/20 text-green-400 border border-green-500/30 rounded-full px-2.5 py-0.5 text-xs font-semibold", children: "✓ Payment Received" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
