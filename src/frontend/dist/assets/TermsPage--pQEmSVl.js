import { j as jsxRuntimeExports, aa as Link, m as motion } from "./index-ek8sCczs.js";
import { A as ArrowLeft } from "./arrow-left-BurPhnK6.js";
import { F as FileText } from "./file-text-grbQM2nK.js";
const sections = [
  {
...
function TermsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 to-blue-950 text-white pb-10", children: [
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold", children: "Terms & Conditions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "Last updated: March 2026" })
            ] })
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-6 max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/80 text-sm leading-relaxed", children: [
            ...
            " — Uttarakhand's ride booking and drone delivery platform. Please read these Terms and Conditions carefully before using our services. These terms govern your use of the PITTHU mobile application and related services."
          ] })
        }
      ),
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: section.content.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-orange-400 mt-0.5 shrink-0", children: "•" }),
                  item
                ]
              },
              item.slice(0, 20)
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 text-center text-white/40 text-xs", children: "By using PITTHU services, you acknowledge that you have read, understood, and agreed to these Terms and Conditions. PITTHU reserves the right to update these terms with 30 days notice to registered users." })
    ] })
  ] });
}
export {
