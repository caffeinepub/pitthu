import { r as reactExports, W as useDirection, I as useControllableState, j as jsxRuntimeExports, J as createContextScope, a3 as useId, Q as Primitive, a4 as createRovingFocusGroupScope, a5 as Root, a6 as Item, L as composeEventHandlers, a7 as Presence, a as cn, a8 as openDB, n as useNavigate, o as useAuth, m as motion, a9 as Mountain, aa as Link, i as ue, ab as Label, a0 as Input, l as Button, ac as LoaderCircle, A as AnimatePresence, ad as ShieldCheck, ae as LogIn } from "./index-CG-f2g7d.js";
import { P as Phone } from "./phone-CpH9-cCL.js";
var TABS_NAME = "Tabs";
...
async function handleRecaptchaFlow(authInstance, request, actionName, actionMethod, recaptchaAuthProvider) {
  var _a;
  {
    if ((_a = authInstance._getRecaptchaConfig()) == null ? void 0 : _a.isProviderEnabled("PHONE_PROVIDER")) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: otpSent && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-blue-500/10 border border-blue-400/20 p-3 text-sm text-blue-200 text-center", children: [
                "OTP sent to +91",
                phone,
                ". Check your SMS."
              ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              demoLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin mr-2" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { className: "w-4 h-4 mr-2" }),
              "Demo Login (No OTP)"
            ]
          }
        ),
...
function LoginPage() {
  ...
  const [demoLoading, setDemoLoading] = reactExports.useState(false);
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      ue.error(msg);
      (_a = recaptchaRef.current) == null ? void 0 : _a.clear();
      recaptchaRef.current = null;
    } finally {
      setLoading(false);
    }
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      if (digits === ADMIN_PHONE) {
        ue.success("Welcome, Admin! Redirecting to dashboard...");
        navigate({ to: "/admin" });
      } else if (activeTab === "driver") {
        ue.success("Welcome, Driver!");
      ...
      const msg = err instanceof Error ? err.message : "Wrong OTP. Please try again.";
      ue.error(msg);
    } finally {
      setVerifying(false);
    }
  ...
  const handleDemoLogin = () => {
    ...
    setTimeout(() => {
      ...
      const ADMIN_PHONE = "9999999999";
      if (digits === ADMIN_PHONE) {
        ue.success("Logged in as admin");
        navigate({ to: "/admin" });
      } else if (activeTab === "driver") {
        ue.success("Logged in as driver");
        navigate({ to: "/driver-dashboard" });
      } else {
        ue.success("Logged in as user");
        navigate({ to: "/" });
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-blue-950 via-blue-900 to-indigo-950 flex flex-col items-center justify-center px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "recaptcha-anchor" }),
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 rounded-xl bg-green-500/10 border border-green-500/20 text-xs text-green-300/80 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-green-300", children: "Demo accounts:" }),
            " ",
